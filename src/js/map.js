document.addEventListener("DOMContentLoaded", function () {
    if (document.querySelector('#map')) {
        ...
        let mapCoords = document.querySelector('#map').getAttribute('data-coords');
        let mapCoordsArray = mapCoords.split(',');
        let mapCoordsLat = mapCoordsArray[0];
        let mapCoordsLng = mapCoordsArray[1];
...
`;
            ...
            if (window.innerWidth < 501) {
                ...
                var myMap = new ymaps.Map("map", {
                    center: [mapCoordsLat, mapCoordsLng],
                    zoom: 16,
                    controls: []
                }, {
            ...
            var myPlacemark = new ymaps.Placemark([mapCoordsLat, mapCoordsLng], {}, {
